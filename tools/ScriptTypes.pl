...
sub version_display{
  print '$Header: ScriptTypes.pl 1.3 2005/08/22 19:56:42BST ghoekstra DEV  $'."\n";
  exit(0);
}
...
=item B<ScriptTypes.pl> B<-i> db1 B<-u> user B<-p> passwd B<-t> schema1.object1

Builds the creation scripts only for the type 'schema1.object1' on database
instance db1.
...
[-l|--dblink DBLink] [-s|--schemas Schemas] [-o|--objects Types] [--no-storage] [--legacy]
...
=item B<-o|--objects List of Objects>
