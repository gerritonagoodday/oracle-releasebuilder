...
sub version_display{
  print '$Header: ScriptSequences.pl 1.2 2005/08/22 19:56:42BST ghoekstra DEV  $'."\n";
  exit(0);
}
...
sub ScriptTextFile{
  ...
  foreach (@schema_objects){
    ...
    print F "  maxvalue $object_row_ref->{MAX_VALUE}\n";
    print F "  increment by $object_row_ref->{INCREMENT_BY}\n";
